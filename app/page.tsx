...
export default function TVSCertificateGenerator() {
  ...
  useEffect(() => {
    setIsClient(true)
    // Sparkles
    const sparkArr = Array.from({ length: 40 }, () => ({
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="relative w-full max-w-[820px] mx-auto min-h-screen h-screen flex flex-col items-center -mt-4 pb-0 mb-0">
        <div
          className="relative w-full h-full rounded-lg shadow-2xl flex flex-col items-center overflow-hidden"
          style={{
        ...
        >
                ...
                {confetti.map((c, i) => (
                  <div
                    ...
                    style={{
                      ...
                      opacity: 0.85,
                      animation: `confetti-fall ${c.animationDuration}s linear infinite`,
          ...
          <div className="relative z-10 flex flex-col items-center text-center px-8 py-8 gap-4 w-full">
            ...
            <div className="relative mb-10 flex flex-col items-center animate-[scale-in_1s_ease-out_1.5s_both]">
              ...
              <div className="w-72 h-72 rounded-full overflow-hidden border-4 border-yellow-400 shadow-2xl relative z-10" style={{background: profileBg}}>
                <Image
